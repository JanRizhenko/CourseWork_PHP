...
<div class="admin-container">
    <div class="admin-header">
        <div>
            ...
            <p>Додайте нову новину до сайту</p>
        </div>
    ...
    <div class="form-container">
        <form method="POST" action="/admin/store-news">
            ...
            <div class="form-group">
                ...
                <textarea id="content" name="content" class="form-control" required><?= isset($_SESSION['old_data']['content']) ? htmlspecialchars($_SESSION['old_data']['content']) : '' ?></textarea>
            </div>
